...
namespace DriveConstants
{
    ...
    constexpr double kRearRightChassisAngularOffset = std::numbers::pi;
...
{
    constexpr auto kMaxSpeed = 1_mps;           // 3_mps;
    constexpr auto kMaxAcceleration = 1_mps_sq; // 3_mps_sq;
    constexpr auto kMaxAngularSpeed = 3.142_rad_per_s;
    constexpr auto kMaxAngularAcceleration = 3.142_rad_per_s_sq;

    constexpr double kPXController = 0.1;     // 0.5;
    constexpr double kPYController = 0.1;     // 0.5;
    constexpr double kPThetaController = 0.1; // 0.5;
