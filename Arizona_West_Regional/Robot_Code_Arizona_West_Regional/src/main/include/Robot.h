...
class Robot : public frc::TimedRobot {
 public:
  ...
  units::second_t delayOuttakeAuto{0.5}; //timer of 500ms
  units::second_t delayActivateGripperAuto{3};
  units::second_t delayDactivateGripperAuto{3.5}; //was 3.5
  units::second_t delayDownArm{3.9};
  units::second_t delayShoot{5};
  units::second_t delayAutoStop{6};
  units::second_t delayhome{6.5};
 ...
 private:
  ...
  // variable
  bool dissableCompressor = false;//false;
