...
constexpr units::meter_t kTrackWidth =
    0.5200_m;  // Distance between centers of right and left wheels on robot
constexpr units::meter_t kWheelBase =
    0.5200_m;  // Distance between centers of front and back wheels on robot

// Angular offsets of the modules relative to the chassis in radians
constexpr double kFrontLeftChassisAngularOffset = 0;//-std::numbers::pi;//0;
constexpr double kFrontRightChassisAngularOffset = 0;//-std::numbers::pi; //0;
constexpr double kRearLeftChassisAngularOffset =0;//-std::numbers::pi; //0;
constexpr double kRearRightChassisAngularOffset = -std::numbers::pi; //0;

// SPARK MAX CAN IDs
constexpr int kFrontLeftDrivingCanId = 12;
constexpr int kRearLeftDrivingCanId = 14;
constexpr int kFrontRightDrivingCanId = 10;
constexpr int kRearRightDrivingCanId = 16;

constexpr int kFrontLeftTurningCanId = 13;
...
constexpr auto kMaxSpeed = 3_mps;//3_mps; //3_mps;
constexpr auto kMaxAcceleration = 3_mps_sq;//3_mps_sq;// 3_mps_sq;
constexpr auto kMaxAngularSpeed = 3.142_rad_per_s;//3.142_rad_per_s;
constexpr auto kMaxAngularAcceleration = 3.142_rad_per_s_sq;//3.142_rad_per_s_sq;

constexpr double kPXController = 0.5;//0.5;
constexpr double kPYController = 0.5;//0.5;
constexpr double kPThetaController = 0.5;//0.006; //0.5;
