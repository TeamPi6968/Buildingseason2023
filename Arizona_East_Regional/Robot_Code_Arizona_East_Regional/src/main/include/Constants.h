...
constexpr double kRearRightChassisAngularOffset = 0;//-std::numbers::pi; //0;
...
constexpr auto kMaxSpeed = 3_mps; //3_mps;
constexpr auto kMaxAcceleration = 3_mps_sq;// 3_mps_sq;
constexpr auto kMaxAngularSpeed = 3.142_rad_per_s;
constexpr auto kMaxAngularAcceleration = 3.142_rad_per_s_sq;

constexpr double kPXController = 0.05;//0.5;
constexpr double kPYController = 0.03;//0.5;
constexpr double kPThetaController = 0.006;//0.006; //0.5;
