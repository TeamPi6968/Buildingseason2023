...
constexpr unsigned char Intake_Pneumatic_Toggle_Joystick = 6; /*Left stick press*/
...
constexpr unsigned char Gripper_Motor_Can_Id = 30;//can id testen en 
constexpr double Gripper_Motor_Max_Speed = 0.15;
...
constexpr double Indexer_Length = 14;
constexpr double Home_Length = 1;//0;
constexpr double Ground_Length = 35;//36;
constexpr double Mid_Length = 21;//21;
constexpr double High_Length = 35;//36;
...
constexpr double Home_Angle = 33;//28;
constexpr double Ground_Angle = 60;//55;
constexpr double Mid_Angle = 120;
constexpr double High_Angle = 140;
constexpr double Loading_Angle = 122.5; // Dit overbruggen tijdens test
